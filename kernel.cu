...
void main()
{
	...
	char rootPath1[] = "C:\\Users\\LQW\\Documents\\Visual Studio 2015\\Projects\\test3\\test3\\TestInput\\";
	char readPath[1024];
	int frame = 2000;
	for (int k = 1; k <= frame; k++)
	{
		...
		char rootPath2[] = "C:\\Users\\LQW\\Documents\\Visual Studio 2015\\Projects\\test3\\test3\\TestOutput\\";
		char writePath[1024];
